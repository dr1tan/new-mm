<template>
  ...
  >
    ...
    >
      <div
        class="animate-shimmer-btn-shimmer-slide absolute inset-0 h-[100cqh] [aspect-ratio:1]"
      >
        <div
    ...
    <!-- Button Text -->
    <span
      class="relative z-10 text-center text-sm font-medium leading-none tracking-tight lg:text-lg"
    >
      <slot />
    </span>
